...
## Subset NEI dataframe by year and by SCC Short Name containing 'coal'
subs_type <- grep("coal", SCC[, 3], ignore.case = T)
scc_sub <- SCC[subs_type, 1]
NEI1999 <- NEI[(NEI$year == 1999 & (NEI$SCC %in% scc_sub)), ]
NEI2002 <- NEI[(NEI$year == 2002 & (NEI$SCC %in% scc_sub)), ]
NEI2005 <- NEI[(NEI$year == 2005 & (NEI$SCC %in% scc_sub)), ]
NEI2008 <- NEI[(NEI$year == 2008 & (NEI$SCC %in% scc_sub)), ]
